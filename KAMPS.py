...
f=[]
doc=['person-location.txt','team-location.txt','software-support-team.txt','team-topics.txt']
dataset=[['person-location.txt',"people-team-location"],['team-location.txt',"team-location"],['software-support-team.txt',"support-team-people"],['team-topics.txt',"topic-team"]]
for x in doc:
